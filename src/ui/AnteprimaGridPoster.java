 ...
 * @author Matteo
 */
public class AnteprimaGridPoster extends javax.swing.JFrame {
	 private IManager manager;
	 private IPoster poster;
	/** Creates new form Modifica */
    public AnteprimaGridPoster(IManager manager) {
...
private void initComponents() {
		...
		cartellonePanel = new AnteprimaGridPanelClass(manager);
		...
		operazioniPanel.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createEtchedBorder(), javax.swing.BorderFactory.createTitledBorder(null, "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Cambria", 1, 14)))); // NOI18N
    ...
    private void changeButtons(java.awt.event.ActionEvent evt){
    	...
    	try {
			if (((GridPoster)poster).getElement(p.x, p.y) instanceof Element)
				anteprimaButton.setEnabled(true);
    	}catch (Exception e) {
			anteprimaButton.setEnabled(false);
		}
    } 
    ...
    private AnteprimaGridPanelClass cartellonePanel;
...
class AnteprimaGridPanelClass extends JPanel implements MouseListener {
	private int row;
	private int col;
	...
	public AnteprimaGridPanelClass(IManager manager)
	{
		this.manager=manager;
